...
### 우선순위 1 (필수) - 1주차 콘텐츠 구현
- [o] 1주차 콘텐츠 데이터 시딩 스크립트 작성 (server/seeds/curriculum.seed.ts)
- [o] 1주차 웹 페이지 구현 (Week1Page.tsx)
- [o] 학습 모듈 상세 페이지 구현 (ModuleDetailPage.tsx)
- [o] 커리큘럼 API 연동 (useCurriculum Hook & Service)

### 우선순위 2 (중요) - 시스템 설정
- [ ] Docker 환경 실행 및 데이터 시딩 (DB 접속 대기 중)
