...
const Week1Page: React.FC = () => {
  ...
  const { modules, weekProgress, loading, error, fetchWeekData, startWeek } = useCurriculum(1);
  ...
  const openModule = (node: MapNode) => {
    navigate(`/curriculum/week/1/module/${node.id}`);
  };
      ...
      <div className="bg-gray-800/50 backdrop-blur-lg border-b border-purple-500/30 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-semibold">대지의 속성 (기초)</h2>
          </div>
              ...
              <div key={chapter.id} className="space-y-2">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold">Chapter 1 - Test</span>
                  </div>
                </motion.button>
              </div>
            ))}
        ...
        <div className="flex-1 p-6 overflow-auto">
          {weekProgress.status === 'locked' ? (
            <div className="flex flex-col items-center justify-center h-full">
              ...
              >
                <h2 className="text-3xl font-bold mb-4">여정을 계속하세요!</h2>
                <p className="text-gray-400 mb-8">몸을 알고 측정하는 것부터 시작합니다.</p>
                <motion.button
                  onClick={startWeek}
